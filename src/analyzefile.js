...
function updatePositions(something){
    ...
    x5 = something[0]["keypoints"][5]["x"];
    

    y5 = something[0]["keypoints"][5]["y"];
    x6 = something[0]["keypoints"][6]["x"];
    y6 = something[0]["keypoints"][6]["y"];
    x7 = something[0]["keypoints"][7]["x"];
    y7 = something[0]["keypoints"][7]["y"];
    x8 = something[0]["keypoints"][8]["x"];
    y8 = something[0]["keypoints"][8]["y"];
    x9 = something[0]["keypoints"][9]["x"];
    y9 = something[0]["keypoints"][9]["y"];
    x10 = something[0]["keypoints"][10]["x"];
    y10 = something[0]["keypoints"][10]["y"];
    x11 = something[0]["keypoints"][11]["x"];
    y11 = something[0]["keypoints"][11]["y"];
    x12 = something[0]["keypoints"][12]["x"];
    y12 = something[0]["keypoints"][12]["y"];
    x13 = something[0]["keypoints"][13]["x"];
    y13 = something[0]["keypoints"][13]["y"];
    x14 = something[0]["keypoints"][14]["x"];
    y14 = something[0]["keypoints"][15]["y"];
    x15 = something[0]["keypoints"][15]["x"];
    y15 = something[0]["keypoints"][15]["y"];
    x16 = something[0]["keypoints"][16]["x"];
    y16 = something[0]["keypoints"][16]["y"];
...
export const passarray = (a)=>{
    //a.forEach(getsPoint);
    for(let i = 0; i<a.length; i++){
        getsPoint(a[i]);
    }
    var score = "Your score is: " + (points * 5);
    //var score = "Your score is: " + (points/a.length)*100 + "%";
